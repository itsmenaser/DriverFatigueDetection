...
pygame.mixer.init()
pygame.mixer.music.load(r'C:\Users\syeda\Downloads\alarm.mp3')
...
predictor_path = r"C:\Users\syeda\Downloads\shape_predictor_68_face_landmarks.dat"
    ...
    for rect in rects:
        ...
        if mouEAR > MOU_AR_THRESH:
            ...
            if COUNT >= MOU_AR_CONSEC_FRAMES:
                ...
                cv2.putText(frame, "YC: {:.2f}".format(YC), (480, 50),cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
        ...
        cv2.putText(frame, "MAR: {:.2f}".format(mouEAR), (480, 60),
            cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
        #cv2.putText(frame,"Qudsia is great",(370,470),cv2.FONT_HERSHEY_COMPLEX,0.6,(153,51,102),1)
    # show the frame
